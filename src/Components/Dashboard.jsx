    ...
    <div className='flex w-full'>
      <div className="side-bar w-14 fixed min-h-screen p-2 shadow">
        <div className='relative top-8'>
          <div className='bg-main hover:bg-mainHover duration-200 my-2 mx-0.5 p-1.5 rounded cursor-pointer' onClick={() => { setUsersPage(true); setClientPage(false) }}>
          ...
          <div className='bg-main hover:bg-mainHover duration-200 my-2 mx-0.5 p-1.5 rounded cursor-pointer' onClick={() => { setUsersPage(false); setClientPage(true) }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" style={{ fill: "rgba(255, 255, 255, 255)" }}>
      ...
      <div className="content w-full ml-14">
        ...
        <div className='bg-[#f8f8f8] min-h-screen p-2'>
          {UsersPage && <UsersList keyword={SearchKeyword} updateKeyword={setSearchKeyword} />}
